...
This documentation defines binding behavior for the X platform adapter
...
## What to do next
Replace the placeholder selector `[data-neo-x-root]` with a real, stable
conversation-root discovery strategy.

## Stability policy
This adapter is **fail-fast** by design:
- If the conversation root cannot be detected, the adapter must throw
